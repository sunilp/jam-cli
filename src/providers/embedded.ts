...
const DEFAULT_MODEL_FILENAME = 'smollm2-360m-instruct-q8_0.gguf';

/**
 * A curated list of known models users can request by short alias.
 * Maps alias → { repo, file }.
 *
 * Note: Only repos/files verified to exist on HuggingFace are listed here.
 * SmolLM2-135M does not have a published GGUF repo.
 */
